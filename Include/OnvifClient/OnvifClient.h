...
public:
	typedef Function1<void, const std::string&> AlarmCallback;
public:
	~OnvifClient();

	shared_ptr<OnvifClientDefs::Info> getInfo(int timeoutms = 10000);			//获取设备信息，错误信息使用XM_GetLastError捕获

	typedef Function1<void, shared_ptr<OnvifClientDefs::Info> > GetInfoCalblack;
	...
	typedef Function1<void, shared_ptr<OnvifClientDefs::Capabilities> > GetCapabilitiesCallback;
...
//	shared_ptr<OnvifClientDefs::Scopes> getScopes(int timeoutms = 10000); //获取描述信息，错误信息使用XM_GetLastError捕获
	...
	typedef Function1<void, shared_ptr<OnvifClientDefs::Profiles> > GetProfilesCallback;
	...
	typedef Function1<void, shared_ptr<OnvifClientDefs::StreamUrl> > GetStreamUrlCallback;
	...
	typedef Function1<void, shared_ptr<OnvifClientDefs::SnapUrl> > GetSnapUrlCallback;
	...
	typedef Function1<void, shared_ptr<OnvifClientDefs::NetworkInterfaces> > GetNetworkInterfacesCallback;
...
//	shared_ptr<OnvifClientDefs::VideoEncoderConfigurations> getVideoEncoderConfigurations(int timeoutms = 10000); //获取视频编码信息，错误信息使用XM_GetLastError捕获
	...
	typedef Function1<void, bool> ContinuousMoveCallback;
	...
	typedef Function1<void, bool> StopPTRCallback;
	...
	typedef Function1<void, bool> SetPresetCallback;
	...
	typedef Function1<void, shared_ptr<OnvifClientDefs::PresetInfos> > GetPresetCallback;
	...
	typedef Function1<void, bool> GotoPresetCallback;
	...
	typedef Function1<void, bool> RemovePresetCallback;
...
//	shared_ptr<OnvifClientDefs::ConfigurationOptions> getConfigurationOptions(const shared_ptr<OnvifClientDefs::PTZConfig>& ptzcfg,int timeoutms = 10000); //错误信息使用XM_GetLastError捕获
	...
	typedef Function1<void, shared_ptr<Time> > GetSystemDateTimeCallback;
	...
	typedef Function1<void, bool> SetSystemDatetimeCallback;
	...
	typedef Function1<void, bool> SystemRebootCallback;
	...
	typedef Function1<void, shared_ptr<OnvifClientDefs::StartRecvAlarm> > StartRecvAlarmCallback;
	...
	typedef Function1<void, shared_ptr<OnvifClientDefs::RecvAlarmInfo> > RecvAlarmCallback;
