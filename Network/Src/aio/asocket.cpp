...
{
	shared_ptr<ASocket> sock(new _SystemSocket(_ioworker, _ioserver, _sockptr, _type));
...
{
	shared_ptr<ASocket> sock(new _SystemSocket(_ioworker, _ioserver, _sockptr, newsock));
