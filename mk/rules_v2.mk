...
TARGET	= $(LIB_TARGET) $(LIB_TARGET_DBG) $(SHARDLIB) $(SHARDLIB_DBG) $(APP_TARGET) ${APP_TARGET_DBG} 
...
${COMPILE_PATH}/%.$(DEBUG_SUFFIX).o:%.cpp 
	$(CPP) -c $(CFLAGS) $(CFLAGS_DBG) $(CPPFLAGS) $< -o $@
...
${COMPILE_PATH}/%.o:%.cpp
	$(CPP) -c $(CFLAGS) $(CFLAGS_NDBG) $(CPPFLAGS) $< -o $@
...
${COMPILE_PATH}/%.cpp.d:%.cpp
	$(CPP) $(CFLAGS) ${CFLAGS_NDBG} $(CPPFLAGS) -MM -MT '$(dir $@)$(subst .cpp.d,.o,$(notdir $@))' -E $^ > $@

${COMPILE_PATH}/%.cc.d:%.cc
	$(CPP) $(CFLAGS) ${CFLAGS_NDBG} $(CPPFLAGS) -MM -MT '$(dir $@)$(subst .cc.d,.o,$(notdir $@))' -E $^ > $@

${COMPILE_PATH}/%.cc.d:%.cxx
	$(CPP) $(CFLAGS) ${CFLAGS_NDBG} $(CPPFLAGS) -MM -MT '$(dir $@)$(subst .cxx.d,.o,$(notdir $@))' -E $^ > $@
...
${COMPILE_PATH}/%.cpp.d.$(DEBUG_SUFFIX):%.cpp
	$(CPP) $(CFLAGS) ${CFLAGS_DBG} $(CPPFLAGS) -MM -MT '$(dir $@)$(subst .cpp.d.$(DEBUG_SUFFIX),.$(DEBUG_SUFFIX).o,$(notdir $@))' -E $^ > $@

${COMPILE_PATH}/%.cc.d.$(DEBUG_SUFFIX):%.cc
	$(CPP) $(CFLAGS) ${CFLAGS_DBG} $(CPPFLAGS) -MM -MT '$(dir $@)$(subst .cc.d.$(DEBUG_SUFFIX),.$(DEBUG_SUFFIX).o,$(notdir $@))' -E $^ > $@

${COMPILE_PATH}/%.cc.d.$(DEBUG_SUFFIX):%.cxx
	$(CPP) $(CFLAGS) ${CFLAGS_DBG} $(CPPFLAGS) -MM -MT '$(dir $@)$(subst .cxx.d.$(DEBUG_SUFFIX),.$(DEBUG_SUFFIX).o,$(notdir $@))' -E $^ > $@
