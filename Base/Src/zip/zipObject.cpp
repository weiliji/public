...
bool Zip::create(const std::string& passwd)
{
	return internal->create(passwd);
}
bool Zip::saveToMem(std::string& data)
{
	return internal->saveToMem(data);
}
bool Zip::saveToFile(const std::string& filename)
{
	return internal->saveToFile(filename);
}

bool Zip::addItemFromMem(const std::string& itemname, const std::string& data)
{
	return internal->addItemFromMem(itemname, data);
}

bool Zip::addItemFromFile(const std::string& itemname, const std::string& filename)
{
